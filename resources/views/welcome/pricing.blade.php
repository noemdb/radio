        ...
        <div class="row">
            <div class="col-12">
                <div class="section-title">
                    <span class="wow fadeInDown" data-wow-delay=".2s">Programas estelares</span>
                    <h2 class="wow fadeInUp" data-wow-delay=".4s">Cuál es tu favorito?</h2>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="single-table wow fadeInUp" data-wow-delay=".2s">
                    ...
                    <!-- Table Bottom -->
                    <div class="button">
                        <a class="btn" href="#">Escuchalo aquí <i class="lni lni-arrow-right"></i></a>
                    </div>
                    <!-- End Table Bottom -->
                </div>
                <!-- End Single Table-->
