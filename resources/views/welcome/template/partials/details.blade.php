<section id="details" class="details" style="background-image: url('{{asset("images/background/brand/details640x320.png")}}') !important;">
    <div class="container">
        ...
        @forelse ($postDetails as $post)
            ...
            <div class="row content">
                ...
                <div class="col-md-8 pt-4" data-aos="fade-up">
                    <h3><div class="text-dark">{{$post->title}}</div></h3>
                    <p class="fst-italic">
